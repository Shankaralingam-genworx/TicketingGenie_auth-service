...
GET /teams/me          Any member: get my team info
"""
...
async def my_agents(
    ...
    return await service.get_agents_for_lead(current_user["team_id"])
...
async def my_team(
    ...
    service = TeamService(db)
    return await service.get_team_for_user(current_user["team_id"])